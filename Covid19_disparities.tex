...
\begin{figure*}
  ...
  \includegraphics[width=0.5\linewidth]{CorrelationMatrix.png}
  \hfill
  \includegraphics[width=0.45\linewidth]{RvsAllPredcitors.pdf}
  \caption[Correlations with multiple predictors]{A: Matric of pairwise Pearson correlation coefficients between the predictor demographic varaibles and attack rate.
